...
\author{
  ...
  \textsuperscript{1}Neapolis University Pafos, Cyprus\quad
  \textsuperscript{2}Metropolia University of Applied Sciences, Helsinki, Finland\quad
  \textsuperscript{3}DataSpike\\[0.4em]
  \small
