...
Beyond these limitations, planned work applies this framework to Common Crawl for expanded coverage, compares BPE distances against typological databases WALS~\citep{wals} and Grambank~\citep{grambank}, and controls for word frequency (\S\ref{sec:e4}) to separate frequency effects from morphological differences.
